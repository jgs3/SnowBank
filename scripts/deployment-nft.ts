...
const config = {
    nft: "0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73",
};
...
async function main() {
    ...
    const nftContract = await utils.deployAndVerify("WILDxNFT", ["Wildx NFT", "WILDxNFT", "https://wildbase.farm/images/nfts/"]);
